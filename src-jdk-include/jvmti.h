...
typedef struct jvmtiInterface_1_ {
  ...
  /*   105 : Test And Set Tag */
  jvmtiError (JNICALL *CompareAndSwapTag) (jvmtiEnv* env, 
    jobject object, 
    jlong tag, 
    jlong compare, 
    jlong* tag_ptr);
...
struct _jvmtiEnv {
  ...
  jvmtiError CompareAndSwapTag(jobject object,
            jlong tag,
            jlong compare,
            jlong* tag_ptr) {
    return functions->CompareAndSwapTag(this, object, tag, compare, tag_ptr);
  }
